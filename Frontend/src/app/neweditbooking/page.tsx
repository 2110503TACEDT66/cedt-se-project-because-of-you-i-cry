          ...
          <div className={styles.rightBlock}>
            <div className={styles.topRight}>
              <div className={styles.priceBlock}>
                ...
                <div className={styles.priceDetail}>THB {bookingResponse?.campground.price}/night</div>
              </div>
              ...
              <div className={styles.buttonBlock}>
                  ...
                  <button type="submit" name="save" onClick={updateReservation} className={styles.save}> 
                    Save
                  </button>
              </div>
            </div>
            <div className={styles.botRight}>
              <button type="submit" name="delete" className={styles.delete} disabled={isDeleting}
              onClick={async () => {
                if (session.data) {
                  setisDeleting(true);
                  try {
